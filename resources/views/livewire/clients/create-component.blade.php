<div id="containerClientesCreate">
    <form wire:submit.prevent="submit">
        ...
        <div class="card text-dark bg-light mb-3">
            ...
            <div class="card-body">
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-2">
                        <label>
                            <input type="radio" value="Don" wire:model="genero">
                            Don
                        </label>
                    </div>
                    <div class="col-sm-2">
                        <label>
                            <input type="radio" value="Doña" wire:model="genero">
                            Doña
                        </label>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="card text-dark bg-light mb-3">
            ...
            <div class="card-body">
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                        <input type="text" wire:model="direccion_tipo_calle" class="form-control" name="direccion"
                            id="direccion"
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                        <input type="text" wire:model="direccion_codigo_postal" class="form-control" name="direccion"
                            id="direccion" placeholder="Dentro de la calle, indica el número de la dirección (12)">
                        @error('direccion')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                        <input type="text" wire:model="direccion_adicional_1" class="form-control" name="direccion"
                            id="direccion" placeholder="Datos adicionales sobre la dirección.">
                        <input type="text" wire:model="direccion_adicional_2" class="form-control" name="direccion"
                            id="direccion" placeholder="Datos adicionales sobre la dirección.">
                        <input type="text" wire:model="direccion_adicional_3" class="form-control" name="direccion"
                            id="direccion" placeholder="Datos adicionales sobre la dirección.">
                        @error('direccion')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
        ...
        <div class="mb-3 row d-flex align-items-center">
            <button type="submit" class="btn btn-warning">Guardar datos del cliente</button>
        </div>
    </form>
</div>

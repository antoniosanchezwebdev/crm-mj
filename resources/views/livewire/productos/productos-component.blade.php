        ...
        @if ($producto != null)
            ...
            @elseif ($tab == 'tab4')
                ...
                <div class="ms-auto col d-grid gap-2">
                    <a class="btn btn-warning btn-block" href="{{ route('proveedores.index') }}"> Consultar y
                        editar proveedores </a>
                    <a class="btn btn-warning btn-block" href="{{ route('ecotasa.index') }}"> Consultar y editar
                        ecotasas </a>
                    <a class="btn btn-warning btn-block" href="{{ route('productos-categories.index') }}"> Consultar y
                        editar
                        categorías </a>
                </div>
            @endif
        ...
        @if ($producto != null)
            @if ($tab == 'tab1')
                <ul class="nav nav-tabs nav-fill">
                    <li class="nav-item">
                        <button class="nav-link active" style="color: #ffaa00;" wire:click.prevent="cambioTab('tab1')"><h3>Buscador</h3></button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" style="color: #ae9700;" wire:click.prevent="cambioTab('tab2')"><h5>Ver/Editar
                            producto</h5></button>
                    </li>
                    <li class="nav-item">
            ...
            @elseif ($tab == 'tab2')
                <ul class="nav nav-tabs nav-fill">
                    <li class="nav-item">
                        <button class="nav-link" style="color: #ae9700;" wire:click.prevent="cambioTab('tab1')"><h5>Buscador</h5></button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" style="color: #ffaa00;" wire:click.prevent="cambioTab('tab2')"><h3>Ver/Editar
                            producto</h3></button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" style="color: #ae9700;" wire:click.prevent="cambioTab('tab3')"><h5>Añadir
        ...
        @else
            @if ($tab == 'tab1')
                <ul class="nav nav-tabs nav-fill">
                    ...
                    <li class="nav-item">
                        <button class="nav-link text-black" wire:click.prevent="cambioTab('tab2')" disabled><h5>Ver/Editar
                            producto</h5></button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" style="color: #ae9700;" wire:click.prevent="cambioTab('tab3')"><h5>Añadir
            ...
            @elseif ($tab == 'tab4')
                ...
                <div class="ms-auto col d-grid gap-2">
                    <a class="btn btn-warning btn-lg" href="{{ route('proveedores.index') }}"> Consultar y
                        editar proveedores </a>
                    <a class="btn btn-warning btn-lg" href="{{ route('ecotasa.index') }}"> Consultar y editar
                        ecotasas </a>
                        <a class="btn btn-warning btn-lg" href="{{ route('fabricantes.index') }}"> Consultar y
                            editar
                            fabricantes </a>
                    <a class="btn btn-warning btn-lg" href="{{ route('productos-categories.index') }}"> Consultar y
                        editar
                        categorías </a>
                </div>
            @endif
